...
""")
# List of gallow statuses representing different stages of the hangman
gallowStatus = [gallow, gHead, gBody, glHand, grHand, glLeg, grLeg]

# Print the initial gallow and the hangman word (underscores)
print(gallow)
print(hangmanWord)
chance = 0 
...
while chance < 6:
    ...
    chosenLetter = str(input("Choose a letter: ")).lower()
    # Check each letter in the chosen word
    for letter in chosenWord:
        if chosenLetter == letter:
            # If the chosen letter is in the word, update hangmanWord
            hangmanWord = hangmanWord[:nth] + chosenLetter + hangmanWord[nth+1:]
            succes += 1 
            nth += 1  
            if nth == cntLetters and succes > 0:
                print(hangmanWord)  
            ...
            if nth == cntLetters and succes > 0:
                print(hangmanWord) 
            elif nth == cntLetters and succes == 0:
                chance += 1 
                print(gallowStatus[chance])  
                print(hangmanWord)  
                if chance == 6:
